...
Except `kling-video-o1`, `kling-3.0-motion-control`, `seedance-2`, `seedance-2-fast`, `seedance-2-preview`, `seedance-2-fast-preview`, and `seedance-2-watermark-remover`, models below do not support `video-to-video`, so `options.video_input` should not be sent.
